...
describe RevisionsController do
  ...
  describe "GET show" do
    it "assigns the requested revision as @revision" do
      revision = Revision.create! valid_attributes
      get :show, {:id => revision.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested revision as @revision" do
      revision = Revision.create! valid_attributes
      get :edit, {:id => revision.to_param}, valid_session
      assigns(:revision).should eq(revision)
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved revision as @revision" do
        ...
        post :create, {:revision => { "user" => "invalid value" }}, valid_session
        assigns(:revision).should be_a_new(Revision)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested revision" do
        ...
        Revision.any_instance.should_receive(:update).with({ "user" => "" })
        put :update, {:id => revision.to_param, :revision => { "user" => "" }}, valid_session
      end

      it "assigns the requested revision as @revision" do
        revision = Revision.create! valid_attributes
        put :update, {:id => revision.to_param, :revision => valid_attributes}, valid_session
        assigns(:revision).should eq(revision)
      end
    ...
    describe "with invalid params" do
      it "assigns the revision as @revision" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Revision.any_instance.stub(:save).and_return(false)
        put :update, {:id => revision.to_param, :revision => { "user" => "invalid value" }}, valid_session
        assigns(:revision).should eq(revision)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested revision" do
      revision = Revision.create! valid_attributes
      expect {
        delete :destroy, {:id => revision.to_param}, valid_session
      }.to change(Revision, :count).by(-1)
    end
