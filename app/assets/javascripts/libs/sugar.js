...
(function () {
	...
	var m = Object,
		...
		ga = !("0" in new s("a")),
		ia = {}, ja = /^\[object Date|Array|String|Number|RegExp|Boolean|Arguments\]$/,
	...
	function jc(a, b, c, d) {
		...
		C(a) ? n.utc(a.isUTC()).setTime(a.getTime()) : y(a) ? n.setTime(a) : G(a) ? (n.set(a, !0), k = a) : z(a) && (ha = Y(b), a = hc(a), ha && I(ha.o ? [ha.o].concat(ha.g) : ha.g, function (c, d) {
			...
			if (g) {
				...
				k.unit && (x = !0, ra = ac(B, k.num), wb = B.units.indexOf(k.unit) % 8, E = W.units[wb], l(), k.shift && (ra *= (ca = B.i[k.shift]) ? ca.value : 0), k.sign && (ca = B.i[k.sign]) && (ra *= ca.value), M(k.weekday) && (n.set({
					weekday: k.weekday
				}, !0), delete k.weekday), k[E] = (k[E] || 0) + ra);
				k.edge && e(h);
	...
	H(r, !0, !0, {
		...
		setISOWeek: function (a) {
			...
			if (!N(a)) return this.set({
					...
					weekday: 1
				}), 1 < a && this.addWeeks(a - 1), 1 !== b && this.advance({
					days: b - 1
				}), this.getTime()
		},
		getISOWeek: function () {
	...
	H(m, !1, !0, {
		...
		merge: function (a, b, c, d) {
			...
			if (a && "string" !== typeof b) for (e in b) if (J(b, e) && a) {
						...
						if (c && (g || f)) if (C(h)) x = new r(h.getTime());
	...
	(function (a) {
		if (ba.btoa) Nc = ba.btoa, Oc = ba.atob;
			...
			Oc = function (c) {
				...
				g = a.indexOf(c.charAt(n++)), h = a.indexOf(c.charAt(n++)), l = a.indexOf(c.charAt(n++)), e = e << 2 | g >> 4, g = (g & 15) << 4 | h >> 2, f = (h & 3) << 6 | l, d += s.fromCharCode(e), 64 != h && (d += s.fromCharCode(g)), 64 != l && (d += s.fromCharCode(f));
				while (n < c.length);
				return d
			}
		}
